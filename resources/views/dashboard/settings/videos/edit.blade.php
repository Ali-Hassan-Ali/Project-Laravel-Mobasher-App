...
@section('title', __('dashboard.dashboard') .' - '. __('dashboard.videos')  .' - '. __('dashboard.edit'))
                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('dashboard.settings.videos.update', $video->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="video_image" class="form-control image">
                        </div>

                        <div class="form-group">
                            <img src="{{ $video->image_path }}" style="width: 100px" class="img-thumbnail image-preview" alt="">
                        </div>

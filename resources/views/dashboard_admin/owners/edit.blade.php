...
@section('title', __('dashboard.dashboard') .' - '. __('dashboard.owners')  .' - '. __('dashboard.edit'))
        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('dashboard.admin.owners.update', $owner->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="first_phone" class="form-control @error('first_phone') is-invalid @enderror" value="{{ old('first_phone', $owner->first_phone) }}">
                            @error('first_phone')
                                <span class="text-danger" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="last_phone" class="form-control @error('last_phone') is-invalid @enderror" value="{{ old('last_phone', $owner->last_phone) }}">
                            @error('last_phone')
                                <span class="text-danger" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            <img src="{{ $owner->image_path }}"  style="width: 100px" class="img-thumbnail image-preview" alt="">
                        </div>

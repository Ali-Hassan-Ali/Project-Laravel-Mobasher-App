...
@section('title', __('dashboard.dashboard') .' - '. __('dashboard.categorys')  .' - '. __('dashboard.add'))
        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('dashboard.admin.categorys.store') }}" method="post" enctype="multipart/form-data">
